...
const CapsuleSchema = new Schema({
  ...
  theme: { type: String, enum: ['Childhood', 'Family History', 'College Years', 'Wedding', 'Other'], default: 'Other' },
  

  privacy: { type: String, enum: ['private', 'public', 'recipients-only'], default: 'recipients-only' },
